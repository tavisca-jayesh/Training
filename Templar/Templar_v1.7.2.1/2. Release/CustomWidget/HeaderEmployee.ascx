<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderEmployee.ascx.cs" Inherits="CustomWidget.HeaderEmployee" %>
<%@ Register Assembly="Tavisca.Templar.WebControls" Namespace="Tavisca.Templar.WebControls" TagPrefix="gtc" %>

<asp:Panel ID="HeaderEmpPanel" runat="server" Visible="false" BackColor="Black" >
